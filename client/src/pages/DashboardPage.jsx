    ...
    <div className="container">
      ...
      <div className="card mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center"><div className="text-2xl font-bold text-blue-600">{user.points}</div><div className="text-gray-600">Civic Points</div></div>
          <div className="text-center"><div className="text-2xl font-bold text-green-600">{/* Mock */}5</div><div className="text-gray-600">Issues Reported</div></div>
          <div className="text-center"><div className="text-2xl font-bold text-purple-600">{/* Mock */}12</div><div className="text-gray-600">Issues Verified</div></div>
        </div>
      </div>
